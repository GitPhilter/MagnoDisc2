...
public class MarkNearestPlayerDiscImpulseActuator extends ImpulseActuator {
    ...
    public Impulse getImpulse(){
        ...
        if(playerDisc.getTeam().getTeamEnum() == TeamEnum.HOME){
            nearestPlayerDisc = PlayerDiscRelations.getClosestOpponenPlayerDisc(playerDisc, game.getAwayTeam().getPlayerDiscs());
        } else {
            nearestPlayerDisc = PlayerDiscRelations.getClosestOpponenPlayerDisc(playerDisc, game.getHomeTeam().getPlayerDiscs());
        }
